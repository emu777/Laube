...
import AvatarIcon from './AvatarIcon'; // ImageとuseSupabaseの代わりにAvatarIconをインポート
    ...
    >
      <div className="rounded-xl overflow-hidden bg-gray-800/50 border border-gray-700/80 shadow-lg w-[160px]">
        <div className="relative w-full aspect-square">
          <AvatarIcon avatarUrlPath={profile.avatar_url} size={160} priority={priority} shape="square" />
          {/* 名前 */}
